...
def test_create_table():
    ...
    check_logs(
        must_contain=[
            ...
            generate_create_table_numbered("(`x` int) ENGINE = JDBC('jdbc://[HIDDEN]@localhost:5432/mydb', 'mydb', 'mytable')"),
            generate_create_table_numbered("(`x` int) ENGINE = ODBC('odbc://[HIDDEN]@localhost:5432/mydb', 'mydb', 'mytable')"),
            ...
            generate_create_table_numbered("(`x` int) ENGINE = JDBC(named_collection_1, datasource = 'jdbc://[HIDDEN]@localhost:5432/mydb', external_database = 'mydb', external_table = 'mytable')"),
            generate_create_table_numbered("(`x` int) ENGINE = ODBC(named_collection_1, connection_settings = 'odbc://[HIDDEN]@localhost:5432/mydb', external_database = 'mydb', external_table = 'mytable')"),
...
def test_table_functions():
    ...
    check_logs(
        must_contain=[
            ...
            "CREATE TABLE tablefunc52 (`x` int) AS jdbc('jdbc://[HIDDEN]@localhost:5432/mydb', 'mydb', 'mytable')",
            "CREATE TABLE tablefunc53 (`x` int) AS odbc('odbc://[HIDDEN]@localhost:5432/mydb', 'mydb', 'mytable')",
            ...
            "CREATE TABLE tablefunc56 (`x` int) AS jdbc(named_collection_1, datasource = 'jdbc://[HIDDEN]@localhost:5432/mydb')",
            "CREATE TABLE tablefunc57 (`x` int) AS odbc(named_collection_1, connection_settings = 'odbc://[HIDDEN]@localhost:5432/mydb')",
